...
class PresentEventTest {
    ...
    companion object {
        ...
        fun provideCheckMatchExample() = listOf(
            ...
            Arguments.of(
                PresentEvent(10, mapOf("아이스크림" to 1, "타파스" to 1, "바비큐립" to 1)),
                false
            ) // 총 주문 금액이 120000원 미만인 경우
        )
        ...
        fun provideGetBenefitExample() = listOf(
            ...
            Arguments.of(
                PresentEvent(9, mapOf("초코케이크" to 3, "레드와인" to 1, "해산물파스타" to 2, "시저샐러드" to 1, "티본스테이크" to 1)),
                -25_000
            ),
